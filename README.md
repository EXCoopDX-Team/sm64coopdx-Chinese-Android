...
合并中。少话。  
你们的Shangshanruo懒完了让我来进行v1.5.1的合并你别笑🤣  

这个分支的中文实现是通过替换日文完成的，如果您需要日文，请联系Bilibili：上善若Shangshanruo 梅塔的长名字。如果确实有人需要，我们可能会将日文重新添加进游戏中。我们不会在Github上发布任何Release，这是为了保证玩家的行为在可控范围内。如果您需要游玩且没有能力构建，请加入QQ群聊981281124，那里有最新的汉化版以及沙雕的群友。
