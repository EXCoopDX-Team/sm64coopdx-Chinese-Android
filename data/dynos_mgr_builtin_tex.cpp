...
static const struct BuiltinTexInfo sDynosBuiltinTexs[] = {
    ...
    define_builtin_tex(texture_touch_confirm, "textures/touchcontrols/touch_button_confirm.rgba16.png", 16, 16, G_IM_FMT_RGBA, G_IM_SIZ_16b),
    define_builtin_tex(texture_touch_confirm_pressed, "textures/touchcontrols/touch_button_confirm_pressed.rgba16.png", 16, 16, G_IM_FMT_RGBA, G_IM_SIZ_16b),
    define_builtin_tex(texture_touch_discard, "textures/touchcontrols/touch_button_discard.rgba16.png", 16, 16, G_IM_FMT_RGBA, G_IM_SIZ_16b),
    define_builtin_tex(texture_touch_discard_pressed, "textures/touchcontrols/touch_button_discard_pressed.rgba16.png", 16, 16, G_IM_FMT_RGBA, G_IM_SIZ_16b),
    define_builtin_tex(texture_touch_reset, "textures/touchcontrols/touch_button_reset.rgba16.png", 16, 16, G_IM_FMT_RGBA, G_IM_SIZ_16b),
    define_builtin_tex(texture_touch_reset_pressed, "textures/touchcontrols/touch_button_reset_pressed.rgba16.png", 16, 16, G_IM_FMT_RGBA, G_IM_SIZ_16b),
    define_builtin_tex(texture_touch_snap, "textures/touchcontrols/touch_button_snap.rgba16.png", 16, 16, G_IM_FMT_RGBA, G_IM_SIZ_16b),
    define_builtin_tex(texture_touch_snap_pressed, "textures/touchcontrols/touch_button_snap_pressed.rgba16.png", 16, 16, G_IM_FMT_RGBA, G_IM_SIZ_16b),
    define_builtin_tex(texture_touch_trash, "textures/touchcontrols/touch_trash.rgba16.png", 16, 16, G_IM_FMT_RGBA, G_IM_SIZ_16b),
#endif
